...
var AutoLayoutView = /** @class */ (function (_super) {
    ...
    AutoLayoutView.prototype.render = function () {
        return (react_1.default.createElement(AutoLayoutViewNativeComponent_1.default, tslib_1.__assign({}, this.props, { onBlankAreaEvent: this.onBlankAreaEventCallback, enableInstrumentation: listeners.length !== 0 || Boolean(this.props.onBlankAreaEvent), disableAutoLayout: this.props.disableAutoLayout, experimentalScrollPositionManagement: Boolean(this.props.experimentalScrollPositionManagement) }), this.props.children));
    };
